<?php require_once '../../../src/routes/ManageDoctors.php'; ?>
	...
	<script>
		var dataSet3 = [
			...
			foreach ($doctors as $doctor)
				echo "[\"{$doctor->getUserInfo()->getFullName()}\" , \" {$doctor->getUserInfo()->getEmail()} \",   \"<form method='POST' style='display: inline;'>  <input type='hidden' name='doctor' value='{$doctor->getId()}'> <button type='submit'> <i class='fas fa-pencil-alt ms-text-primary'></i></button></form>\"],";
			?>
