<?php require_once "./src/routes/PatientSignIn.php"; ?>
	...
	<div class="sign-in-area ptb-100">
		<div class="container">
			<div class="sign-in-form">
				...
				<form method="POST">
					<div class="row">
						<?php if ($errors !== null) echo " <div class='col-lg-12'><div class='alert alert-danger' role='alert'>{$errors}</div></div> "; ?>
						<div class="col-lg-12">
							<div class="form-group">
								<input value="<?php echo reclaimPostItem('email') ?>" name="email" type="email" class="form-control" placeholder="Email">
							</div>
						</div>
						...
						<div class="col-lg-12 text-right">
							<p class="forgot-password"><a href="single-events.html">Forgot Password?</a></p>
						</div>
