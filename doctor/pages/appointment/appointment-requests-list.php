<?php require_once '../../../src/routes/ManageRequests.php'; ?>
	...
	<main class="body-content">
		...
		<nav class="navbar ms-navbar">
			...
			<div class="logo-sn logo-sm ms-d-block-sm">
				<a class="pl-0 ml-0 text-center navbar-brand mr-0" href="../../index-2.html"><img src="../../assets/img/Zona Health-logo-84x41.png" alt="logo"> </a>
			</div>
					...
					<div class="ms-panel">
						...
						<div class="ms-panel-body">
							<div class="table-responsive">
								<table id="doctor-table" class="table table-striped thead-primary w-100"></table>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="ms-panel ms-panel-bshadow-none">
							...
							<div class="ms-panel-body">
								<form class="needs-validation" novalidate>
									<div class="form-row">
										<div class="col-md-4 mb-3">
											<label for="validationCustom16">Doctor Name</label>
											<div class="input-group">
	...
	<script>
		var dataSet3 = [
			...
			foreach ($requests as $request)
				echo "[\"{$request->getPatient()->getUserInfo()->getFullName()}\" , \" {$request->getPatient()->getUserInfo()->getEmail()} \",   \"<form method='POST' style='display: inline;'> <input style='display: inline; margin: 0;' type='text' placeholder='Select a time' class='datetime flatpickr-input fix-input'  name='time'/> <input type='hidden' name='request' value='{$request->getId()}'/> <button type='submit'> <i class='fas fa-pencil-alt ms-text-primary'></i></button></form>\"],";
			?>

		];

		var tableFour = $('#doctor-table').DataTable({
			data: dataSet3,
			columns: [{
					title: "Patient Name"
				},
