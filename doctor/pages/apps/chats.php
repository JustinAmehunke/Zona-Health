<?php require_once '../../../src/routes/DoctorChat.php'; ?>
	...
	<aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
		...
		<div class="logo-sn ms-d-block-lg">
			<a class="pl-0 ml-0 text-center" href="../../index.html">
				<h2 style="color: white;">Zona Health</h2>
			</a>
			<a href="#" class="text-center ms-logo-img-link">
				<img src="../../assets/img/dashboard/doctor-3.jpg" alt="logo" /></a>
		...
		<ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
			...
			<li class="menu-item">
				...
				<ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
					<li><a href="../../index.html">Zona Health</a></li>
				</ul>
			</li>
			<!-- /Dashboard -->
			<!-- Doctor -->
			...
			<li class="menu-item">
				...
				<ul id="schedule" class="collapse" aria-labelledby="schedule" data-parent="#side-nav-accordion">
					<!-- <li>
						<a href="../doctor-schedule/add-schedule.html">Add Schedule</a>
					</li> -->
					<li>
						<a href="../doctor-schedule/schedule-list.html">Schedule List</a>
					</li>
				</ul>
			</li>
			<!-- /Schedule -->
			...
			<li class="menu-item">
				...
				<ul id="appointment" class="collapse" aria-labelledby="appointment" data-parent="#side-nav-accordion">
					<!-- <li>
						<a href="../appointment/add-appointment.html">Add Appointment</a>
					</li> -->
					<li>
						<a href="../appointment/appointment-list.html">Appointment List</a>
					</li>
				</ul>
			</li>
			<!-- /Appointment -->
			...
			<li class="menu-item">
				...
				<ul id="report" class="collapse" aria-labelledby="report" data-parent="#side-nav-accordion">
					<li><a href="../report/patient-report.html">Doctor's Report</a></li>
			...
			<li class="menu-item">
				...
				<ul id="apps" class="collapse" aria-labelledby="apps" data-parent="#side-nav-accordion">
					<li><a href="../apps/chats.html">Chat</a></li>
		...
		<div class="ms-aside-header">
			<ul class="nav nav-tabs tabs-bordered d-flex nav-justified mb-3" role="tablist">
				<li role="presentation" class="fs-12">
					<a href="#activityLog" aria-controls="activityLog" class="active" role="tab" data-toggle="tab">
						Activity Log</a>
				</li>
				<li role="presentation" class="fs-12">
					<a href="#recentPosts" aria-controls="recentPosts" role="tab" data-toggle="tab">
						Settings
					</a>
				</li>
				<li>
	...
	<main class="body-content">
		...
		<nav class="navbar ms-navbar">
			...
			<div class="logo-sn logo-sm ms-d-block-sm">
				<a class="pl-0 ml-0 text-center navbar-brand mr-0" href="../apps/index.html"><img src="../../assets/img/Zona Health-logo-84x41.png" alt="logo" />
				</a>
			</div>
			<ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
				...
				<li class="ms-nav-item ms-nav-user dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
						<li class="dropdown-menu-header">
							<h6 class="dropdown-header ms-inline m-0">
								<span class="text-disabled">Welcome, Dr Samuel Deo</span>
							</h6>
						</li>
						<li class="dropdown-divider"></li>
						<li class="ms-dropdown-list">
							<a class="media fs-14 p-2" href="../prebuilt-pages/user-profile.html">
								<span><i class="flaticon-user mr-2"></i> Profile</span>
							</a>
							<a class="media fs-14 p-2" href="email.html">
						...
						<li class="dropdown-menu-footer">
							<a class="media fs-14 p-2" href="../prebuilt-pages/lock-screen.html">
								<span><i class="flaticon-security mr-2"></i> Lock</span>
							</a>
						</li>
						<li class="dropdown-menu-footer">
							<a class="media fs-14 p-2" href="../prebuilt-pages/default-login.html">
		...
		<div class="ms-content-wrapper">
							...
							<div class="ms-chat-container">
								...
								<div class="ms-chat-body">
									<ul class="nav nav-tabs tabs-bordered d-flex nav-justified px-3" role="tablist">
										<li role="presentation" class="fs-12">
											<a href="#chats-2" class="active show" role="tab" data-toggle="tab">
												Chats
											</a>
										</li>
										<!--<li role="presentation" class="fs-12">
                        <a href="#groups-2" role="tab" data-toggle="tab">
                          Groups
                        </a>
                      </li>
                      <li role="presentation" class="fs-12">
                        <a href="#contacts-2" role="tab" data-toggle="tab">
                          Contacts
                        </a>
		      </li> ---->
									</ul>
	       ...
	       echo "	<li data-patient-fullname='{$appointment->getPatient()->getUserInfo()->getFullName()}'  data-appointment-time=\"{$appointment->getTime()}\"
			data-patient-email=\"{$appointment->getPatient()->getUserInfo()->getEmail()}\" class=\"ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix appointment\"
                          >
                            <div
                              class=\"ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center\"
                            >
                              <!--<img
                                src=\"../../assets/img/dashboard/employee-list/employee-(3).jpg\"
                                class=\"ms-img-round\"
                                alt=\"people\"
				/>---->
                            </div>
                            <div class=\"media-body ms-chat-user-info mt-1\">
				    <h6>{$appointment->getPatient()->getUserInfo()->getFullName()}</h6>
				    <span class=\"ms-chat-time\">{$appointment->getPrettyTime()}</span>
                              <p>
			      Appointment Today
                              </p>
				...
				<div  class="col-xl-8 col-md-12">
					<div id="talkjs-container" style="display: flex;" ></div>
				</div>
<style>
.center-stage{
	max-width: 100%;
	...
	<div class="modal fade" id="notes-modal" tabindex="-1" role="dialog" aria-labelledby="notes-modal">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header bg-secondary">
					<h5 class="modal-title has-icon text-white" id="NoteModal">
						New Note
					</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						...
						<div class="ms-panel ms-panel-bshadow-none">
							...
							<div class="ms-panel-body">
								<form class="needs-validation" novalidate>
									...
									<button class="btn btn-warning mt-4 d-inline w-20" type="submit">
										Reset
									</button>
									<button class="btn btn-primary mt-4 d-inline w-20" type="submit">
										Add Appointment
									</button>
								</form>
							</div>
    ...
    window.me = new Talk.User({
	    id: '<?php echo "{$user->getUserInfo()->getEmail()}"; ?>',
	    name: '<?php echo "{$user->getUserInfo()->getFullName()}"; ?>',
        email: '<?php echo "{$user->getUserInfo()->getEmail()}"; ?>',
    });
    window.talkSession = new Talk.Session({
        appId: "tCN82MVf",
        me: me
    });
			     chatbox =  window.talkSession.createChatbox(null);
		...
		function attachListeners() {
			for (let appointment of appointments) {
				appointment.addEventListener('click', viewAppointmentChat);
			}
		}

		function viewAppointmentChat(event) {
console.log('hello');
			let patientEmail = event.currentTarget.getAttribute('data-patient-email');
			let patientFullName = event.currentTarget.getAttribute('data-patient-fullname');
conversation = talkSession.getOrCreateConversation(Talk.oneOnOneId('<?php echo "{$user->getUserInfo()->getEmail()}"; ?>', patientEmail));
    ...
    chatbox.select(conversation);
		...
		function appointmentsCheck() {
			...
			for (let appointment of appointments) {
				let appTime = appointment.getAttribute('data-appointment-time');
				appTime = parseInt(appTime) * 1000;
				if (appTime < nowTimestamp) {
					if (!appointment.classList.contains('appointment-inactive')) {
						appointment.classList.add('appointment-inactive');
					}
				} else {
					if (appointment.classList.contains('appointment-inactive')) {
						appointment.classList.remove('appointment-inactive');
					}
				}
